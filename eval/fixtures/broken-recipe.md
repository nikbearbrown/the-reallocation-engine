...
Do not "fix" this by other means — the point is the minimal correct repair.

## Steps

1. This is placeholder body content so the file looks like a real recipe.
2. It has a balanced code fence below to prove only the front-matter is at fault.
